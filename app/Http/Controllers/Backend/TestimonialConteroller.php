...
class TestimonialConteroller extends Controller
{
    //
    public function AllTesimonial()
    {
    ...
    public function StoreTestimonial(Request $request)
    {
        ...
        $notification = array(
          'massage' => 'Testimonial Data Inserted Successfully',
          'alert-type' => 'success'
        );
