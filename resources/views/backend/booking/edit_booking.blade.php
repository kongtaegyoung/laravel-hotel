                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('assing_room_delete',$assign_room->id) }}" id="delete">Delete</a></td>
                                </tr>
                                @endforeach
                            </table>
                            @else
                        ...
                        <form action="{{ route('update.booking.status',$editData->id) }}" method="POST">
                            ...
                            <div class="row" style="margin-top: 40px;">
                                ...
                                <div class="col-md-12" style="margin-top: 20px;">
                                    ...
                                    <a href="{{ route('download.invoice',$editData->id) }}" class="btn btn-warning px-3 raius-10"><i class="lni lni-download"></i>Download Invoice</a>
                                </div>
