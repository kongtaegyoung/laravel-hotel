                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="roomtype_id" class="form-control" id="input1" placeholder="First Name" value="{{ $editData['type']['name'] }}">
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="total_child" class="form-control" id="input3"  value="{{ $editData->total_child }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="multiImag" class="form-label">Gallery Image</label>
                                                        ...
                                                        <div  id="preview_img" class="d-flex"></div>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label for="price" class="form-label">Room Price</label>
                                                        <input type="text" name="price" class="form-control" id="price" value="{{ $editData->price }}"  >
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="size" class="form-label">Size</label>
                                                        <input type="text" name="size" class="form-control" id="size" value="{{ $editData->size }}"  >
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="discount" class="form-label">Discount ( % )</label>
                                                        <input type="text" name="discount" class="form-control" id="discount" value="{{ $editData->discount }}" >
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="room_capacity" class="form-label">Room Capcity</label>
                                                        <input type="text" name="room_capacity" class="form-control" id="room_capcity" value="{{ $editData->room_capacity }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="bed_style" id="input9" class="form-select">
                                                            <option selected="">Choose...</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea class="form-control" name="description" id="myeditorinstance" placeholder="Address ..." rows="3"> {!! $editData->description !!} </textarea>
                                                    </div>
                                                   ...
                                                   @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="room_no" class="form-control" id="room_no" value="">
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select id="status" name="status" class="form-select">
                                                                ...
                                                                <option value="Active" {{$editData->view == 'Active'?'selected':''}}>Active</option>
                                                                <option value="Inactive" {{$editData->view == 'Inactive'?'selected':''}}>Inactive</option>
                                                            </select>
                                                        </div>
                    ...
                    $.each(data, function(index, file){
                        if(/(\.|\/)(gif|jpe?g|png)$/i.test(file.type)){
                            ...
                            fRead.onload = (function(file){
                                return function(e) {
                                    var img = $('<img/>').addClass('thumb position-relative mr-3').attr('src', e.target.result).width(100).height(80);
                                    var btn = $('<button/>').text('X').addClass('btn btn-danger btn-sm deleteBtn position-absolute').css({top: 0, right: 0});
                                    var wrapper = $('<div/>').addClass('imgWrap position-relative d-inline-flex align-items-center');
                                    wrapper.append(img);
                                    img.after(btn);
