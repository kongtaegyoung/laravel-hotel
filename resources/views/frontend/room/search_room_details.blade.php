    ...
    <div class="row align-items-center">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input autocomplete="off"   type="text" required name="check_in" id="check_in" value="{{ old('check_in') ? date('Y-m-d', strtotime(old('check_in'))) :'' }}" class="form-control dt_picker" placeholder="yy-mm-dd">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input autocomplete="off"   type="text" required name="check_out" id="check_out" value="{{ old('check_out')  ? date('Y-m-d', strtotime(old('check_out'))) :'' }}" class="form-control dt_picker" placeholder="yy-mm-dd">
                    <span class="input-group-addon"></span>
                </div>
                <i class='bx bxs-calendar'></i>
            </div>
        ...
        <div class="col-lg-12 col-md-12">
            <table class="table">
                ...
                <tr>
                    <td><p> Subtotal</p></td>
                    <td><p style="text-align: right"><span class="t_subtotal">0</span></p></td>
                </tr>
                <tr>
                    <td><p> Discount</p></td>
                    <td><p style="text-align: right"><span class="t_discount">0</span></p></td>
                </tr>
                <tr>
                    <td><p> Total</p></td>
                    <td><p style="text-align: right"><span class="t_g_total">0</span></p></td>
                </tr>
                </tbody>
            </table>
                                    ...
                                    <div class="services-bar-widget">
                                        ...
                                        <div class="side-bar-list">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#"> <b>Bed Style : </b> {{ $roomdetails->bed_style }} / Twin <i class='bx bxs-cloud-download'></i></a>
                                                </li>
