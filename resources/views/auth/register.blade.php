                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" action="{{ route('register') }}" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input class="form-control" type="password_confirmation" name="password_confirmation" placeholder="Password Confirmation @error('password_confirmation') is-invalid @enderror">
