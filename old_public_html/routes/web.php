...
Route::add('post', '/posts', '\App\Controllers\PostController::store', [ AuthMiddleware::class,
    RequireMiddleware::class, CsrfTokenMiddleware::class ]);
...
Route::add('patch', '/posts/{id}', '\App\Controllers\PostController::update', [ AuthMiddleware::class,
    RequireMiddleware::class, CsrfTokenMiddleware::class ]);
Route::add('delete', '/posts/{id}', '\App\Controllers\PostController::destroy', [ AuthMiddleware::class,
    RequireMiddleware::class, CsrfTokenMiddleware::class ]);